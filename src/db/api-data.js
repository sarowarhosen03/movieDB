...
export  function  updateMovie  ({id,title}) {
    const index = movieList.results.findIndex((movie) => movie.id === parseInt(id));
 if(index===-1)
    throw  new Error("Movie not found")

    movieList.results[index] = {...movieList.results[index],title};
...
export  function  deleteMovie  (id) {
    ...
    if(index===-1)
        throw  new Error("Movie not found")
   const toDelete = {...movieList.results[index]};
